...
exports.load = function(req, res, next, id) {
    models.Comment.find({where: {id: Number(id)}})
...
exports.loggedUserIsAuthor = function(req, res, next) {
    if (req.session.user && req.session.user.id == req.comment.authorId) {
        ...
        console.log('Operación prohibida: '+
         'El usuario logeado no es el autor del comentario.');
        res.send(403);
    }
};
...
exports.show = function(req, res, next) {
    ...
    models.User.find({where: {id: req.post.authorId}})
            .success(function(user) {
                ...
                models.User.find({where: {id: req.comment.authorId}})
                        .success(function(user) {
...
exports.new = function(req, res, next) {
    var comment = models.Comment.build({ body: 'Introduzca el texto del comentario'});
    res.render('comments/new', {comment: comment, post: req.post });
};

// GET /posts/33/comments/66/edit
exports.edit = function(req, res, next) {
    res.render('comments/edit', {comment: req.comment, post: req.post});
};

// POST /posts/33/comments
exports.create = function(req, res, next) {
    var comment = models.Comment.build({ body: req.body.comment.body,
